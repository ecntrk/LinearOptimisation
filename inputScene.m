...
r_ij(1,:) = [20,150,230,250,410,560,390,420]; %A
r_ij(1,:) = [150,25,120,100,260,410,280,280]; %B
r_ij(1,:) = [230,120,25, 80,240,270,160,160]; %C
r_ij(1,:) = [250,100,80, 20,160,310,240,240]; %D
r_ij(1,:) = [410,260,240,160,25,150,260,380]; %E
r_ij(1,:) = [560,410,270,310,150,25,110,230]; %F
r_ij(1,:) = [390,280,160,240,260,110,20,120]; %G
r_ij(1,:) = [420,280,160,240,380,230,120,25]; %H
